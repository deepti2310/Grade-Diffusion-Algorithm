...
class GGD(object):
    ...
    def _select_relay_node(self, node):
        ...
        although it serves the purpose of minimizing the depleted nodes, but its not global optimized solutions, 
        in reality source, sink changes constantly in a given simulation/real environment, so taking neighbors in consideration
        further depletes the neighbors nodes rapidly which are very near to the sink, given the time we can fully look in to this matter. 
        """
        """
