...
class GD(object):
    ...
    def simulate(self):
        ...
        return seq_list
    def calculate_b_th(self, beta=0.3):
        b_th = 0
        ...
        for node in self.graph:
            for entry in self.graph.node[node]['routing_table']:
                relay_node = entry['relay_node']
                print relay_node    
            #print inside_nodes  
            #grade_dict_now[len(inside_nodes)]+=1
        print grade_dict_orig, grade_dict_now
