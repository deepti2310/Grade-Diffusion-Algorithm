    ...
    def simulate(self):
        ...
        for i in range(self.datapackages):
          ...
          while(current_node != sink):
            ...
            print current_node, self._inside_nodes(current_node)
